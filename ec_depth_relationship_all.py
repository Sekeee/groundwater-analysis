...
def plot_station(station_code, df):
    ...
    ax.xaxis.set_ticks([])
    ax.invert_yaxis()
    plt.title(f'EC vs Depth Relationship for {station_code} Stations', 
             fontsize=14, 
             fontweight='bold',
             pad=30)
    ...
    outname = f'ec_depth_relationship_{station_code.lower()}.png'
